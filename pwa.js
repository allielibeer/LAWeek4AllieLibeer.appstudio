...
const cacheName = 'LAWeek4AllieLibeer_appstudio-2021-02-24 15:52:57.318797'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWeek4AllieLibeer_appstudio'.length) === 'LAWeek4AllieLibeer_appstudio') {
